...
const PROGRAMS = {
  "sales-growth-accelerate-blueprint": {
    ...
    amountInr: 5000,
    tagline: "Advanced blueprint to improve sales confidence, process and conversion.",
    badge: "Blueprint",
  },
  "sales-shakthi": {
    id: "sales-shakthi",
...
function App() {
  ...
  const selectedProgram =
    PROGRAMS[selectedProgramId] || PROGRAMS["sales-growth-accelerate-blueprint"];
      ...
      <main className="page">
        <section className="success-layout">
          ...
          <div className="poster-card">
            <img src={poster} alt="Deepthi sales program" />
          </div>
        </section>
      </main>
    );
    ...
    <main className="page">
      <section className="hero-layout">
        <div className="content-card">
          ...
          <p className="sub">
            Register for the right program and complete payment securely through
            Razorpay.
          </p>
